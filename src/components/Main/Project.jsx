...
const TAGS = {
  ...
  SCSS: {
    ...
    icon: () => (
      <svg className="project-tag-icon" viewBox="0 0 512 384" xmlns="http://www.w3.org/2000/svg" width="512" height="384">
...
const PROJECT_IMAGES = {
  lawfirm: proyectoCuatro,
  anzuelo: proyectoSeis,
};

const Projects = () => {
  const { translate } = useTranslation();
  const projects = translate('projectList');

  return (
    <div className="projects-container" id="project">
      <h2 className="projects-title" data-aos="fade-up" data-aos-delay="100">
        {translate('projects')}
      </h2>

      {projects.map(({ imageKey, title, description, tagKeys, link, github }) => (
        <article key={title} className="project-card">
          <div className="project-image-container" data-aos="fade-up" data-aos-delay="200">
            <img alt={title} className="project-image" loading="lazy" src={PROJECT_IMAGES[imageKey]} />
          </div>

          <div className="project-info">
            <h3 className="project-title" data-aos="fade-up" data-aos-delay="200">
              {title}
            </h3>
            ...
            <div className="project-description" data-aos="fade-up" data-aos-delay="200">
              {description}
            </div>
              ...
              {link && (
                <button className="button-link">
                  <a href={link} className="project-link" target="_blank" rel="noopener noreferrer">
                    <svg className="project-tag-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
