        ...
        <footer className="footer">
            <div className="site-footer">
                ...
                <div className="redes-sociales">
                    <a href="https://www.linkedin.com/in/mijael-figueroa-019952249?trk=contact-info" target="_blank" rel="noopener noreferrer"><i className="bi bi-linkedin"></i></a>
                    ...
                    <a href="https://api.whatsapp.com/send?phone=541136817159" target="_blank" rel="noopener noreferrer"><i className="bi bi-whatsapp"></i></a>
                </div>
            </div>
        </footer>
    )
