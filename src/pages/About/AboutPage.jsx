        ...
        <section className="sobre-mi-seccion">
          <div className="sobre-mi-container">
            ...
            <div className="sobre-mi-info">
              <p>
              Hola, mi nombre es Mijael Figueroa y desarrollo soluciones web con enfoque full stack. Me formé en Desarrollo Web en la Universidad Pública de Ezeiza (UPE) y complementé esa base con formación intensiva en Coderhouse, donde me certifiqué en Desarrollo Web, JavaScript, React JS y Backend.
              Mi perfil combina frontend, backend, bases de datos e integraciones para construir aplicaciones que no solo se ven bien, sino que también resuelven procesos reales de negocio. Tambien realicé un curso de Ciberseguridad para sumar mejores prácticas de resguardo, validación y criterio técnico.
              Disfruto trabajar en equipo, tomar decisiones de implementación y seguir aprendiendo sobre producto, arquitectura y performance. Mi objetivo es aportar valor en proyectos donde haga falta criterio técnico, capacidad de ejecución y una mentalidad orientada a construir software útil y mantenible.
              </p>
