...
const AboutPage = () => {
  ...
  return (
    ...
    <main>
    <section className="sobre-mi-container" id="sobre-mi">
            ...
            <div className="columns col-skill" data-aos="fade-left" data-aos-delay="650">
                ...
                <div className="skill">
                    <div>
                        <svg className="icons-skils" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 452 520">
                    ...
                    <div>
                        <svg className="icons-skils" xmlns="http://www.w3.org/2000/svg" width="2500" height="2500" viewBox="0 0 1052 1052">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 512 384" xmlns="http://www.w3.org/2000/svg" width="512" height="384">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 256 204" xmlns="http://www.w3.org/2000/svg" width="256" height="204" preserveAspectRatio="xMidYMid">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 256 228" width="256" height="228" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
                ...
                <div className="skill">
                    ...
                    <div>
                        <svg className="icons-skils" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="64" height="64">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 256 549" xmlns="http://www.w3.org/2000/svg" width="256" height="549" preserveAspectRatio="xMidYMid">
                ...
                <div className="skill">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 256 254" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="256" height="254" preserveAspectRatio="xMidYMid">
                            <defs>
                    ...
                    <div>
                        <svg className="icons-skils" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 256">
                    ...
                    <div>
                        <svg className="icons-skils" viewBox="0 0 256 250" width="256" height="250" fill="currentColor" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
